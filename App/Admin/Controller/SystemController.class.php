...
{   
    ...
    {   
        ...
        // 默认显示条数
        $systemData['RANKING_DEFAULT_NUM'] = I('post.RANKING_DEFAULT_NUM/d', 10);
        $systemData['RANKING_DEFAULT_NUM'] = $systemData['RANKING_DEFAULT_NUM']?$systemData['RANKING_DEFAULT_NUM']:10;
