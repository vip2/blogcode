...
<!-- S -->
<form class="form-horizontal form-search" role="form" method="get" action="/index.php/Admin/Tag/index/pnum/15/p/1.html">
	<div class="my-table-tool" id="my-table-tool">
		<input type="text" name="keywords" value="<?php echo ((isset($_GET['keywords']) && ($_GET['keywords'] !== ""))?($_GET['keywords']):''); ?>" placeholder="搜索用标签名称" class="nav-search-input input-sm" id="nav-search-input" autocomplete="off">
