...
<div class="widget-container-col" id="widget-container-col-11">
	<div class="widget-box widget-color-blue2" id="widget-box-11">
		...
		<div class="widget-body">
			<!-- 表单 开始 -->
			<form class="form-horizontal" method="POST" role="form" action="/index.php/Admin/Navs/edit/id/1.html">
			<!-- 主体 S -->
			<div class="widget-main">
				<div class="row">
				<div class="col-xs-12 col-sm-6">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-title"> 导航名称 </label>
						<div class="col-sm-9">
							<input type="text" id="field-title" name="title" value="<?php echo ((isset($data["title"]) && ($data["title"] !== ""))?($data["title"]):''); ?>" placeholder="导航名称" class="col-xs-10 col-sm-10" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-isurl"> 是不是链接 </label>
						<div class="col-sm-9">
							<input name="isurl" value="1" id="field-isurl" 
								<?php if(((isset($data["isurl"]) && ($data["isurl"] !== ""))?($data["isurl"]):1) == "1"): ?>checked<?php endif; ?> class="ace ace-switch ace-switch-7" type="checkbox" />
								<span class="lbl"></span>
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-status"> 导航状态 </label>
						<div class="col-sm-9">
							<input name="status" value="1" id="field-status" 
								<?php if(($data["status"]) == "1"): ?>checked<?php endif; ?> class="ace ace-switch ace-switch-7" type="checkbox" />
								<span class="lbl"></span>
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-url"> 导航链接 </label>
						<div class="col-sm-9">
							<input type="text" id="field-url" name="url" value="<?php echo ((isset($data["url"]) && ($data["url"] !== ""))?($data["url"]):''); ?>" placeholder="导航链接" class="col-xs-10 col-sm-10" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-sort"> 导航排序 </label>
						<div class="col-sm-9">
							<input type="text" id="field-sort" name="sort" value="<?php echo ($data["sort"]); ?>" placeholder="导航排序" class="col-xs-10 col-sm-10" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="field-keywords" name="keywords" value="<?php echo ((isset($data["keywords"]) && ($data["keywords"] !== ""))?($data["keywords"]):''); ?>" placeholder="关键词" class="col-xs-10 col-sm-10" />
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-description"> 导航描述 </label>
						<div class="col-sm-9">
							<textarea id="field-description" name="description" placeholder="导航描述" class="col-xs-10 col-sm-10"><?php echo ((isset($data["description"]) && ($data["description"] !== ""))?($data["description"]):''); ?></textarea>
						</div>
					</div>
			...
			<?php if(!empty($_GET['pid'])): ?><input type="hidden" name="pid" value="<?php echo ($_GET['pid']); ?>"><?php endif; ?>
			</form>
			<!-- 表单 结束 -->
		</div>
	</div>
