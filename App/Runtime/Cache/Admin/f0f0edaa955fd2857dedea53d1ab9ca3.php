...
<html lang="en">
	<head>
		...
		<style type="text/css">
			.captcha-input .input-icon{top:2px;}
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i class="ace-icon <?php echo ($systemConfig["web_icon"]); ?>"></i>
									<span class="red"><?php echo ($systemConfig["web_title"]); ?></span>
								</h1>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="/index.php/Admin/Login/index.html">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="账号" name="adminuser" />
													...
													<div class="clearfix">
														<label class="inline width-60 captcha-input">
															<span class="block input-icon input-icon-right">
																<input type="text" name="captcha" class="form-control" placeholder="验证码" />
																<i class="ace-icon fa fa-puzzle-piece"></i>
															</span>
														</label>
														<label class="inline width-30">
															<img src="<?php echo U('chkcode');?>" class="captcha-img" onclick="this.src='<?php echo U('chkcode');?>#'+Math.random();" alt="点击切换验证码" title="点击切换验证码"/>
														</label>
													</div>
