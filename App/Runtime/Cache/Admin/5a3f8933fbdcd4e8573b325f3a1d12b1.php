...
<div class="widget-container-col" id="widget-container-col-11">
	<div class="widget-box widget-color-blue2" id="widget-box-11">
		...
		<div class="widget-body">
			<!-- 表单 开始 -->
			<form class="form-horizontal" method="POST" role="form" action="/index.php/Admin/Tag/edit/id/32.html">
			<!-- 主体 S -->
			<div class="widget-main">
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="field-tagname"> 标签名称 </label>
						<div class="col-sm-9">
							<input type="text" id="field-tagname" name="tagname" value="<?php echo ((isset($data["tagname"]) && ($data["tagname"] !== ""))?($data["tagname"]):''); ?>" placeholder="标签名称" class="col-xs-10 col-sm-10" />
						</div>
					</div>
