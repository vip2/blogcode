				...
				<table id="data-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<td class="center"><?php echo (cutStr($vo["url"],20)); ?></td>
								<td class="center"><?php echo (cutStr($vo["keywords"],20)); ?></td>
								<td class="center"><?php echo (cutStr($vo["description"],20)); ?></td>
								...
								<td class="center">
									<div class="action-buttons">
										<?php if(($vo["isurl"]) == "0"): ?><a class="blue add" title="新增下级导航" href="<?php echo U('add',array('pid'=>$vo['id']));?>">
