	...
	<div class="widget-box widget-color-blue2" id="widget-box-11">
		<div class="widget-header">
			...
			<div class="widget-toolbar">
				<a href="javascript:void(0);" class="href-url" title="新增" onclick='location.href="<?php echo U('add',array('pid'=>0));?>"' data-action="settings">
		...
		<div class="widget-body">
			...
			<div class="widget-main no-padding scrollable" data-size="125">
				...
				<table id="data-table" class="table table-bordered table-hover">
					<thead>
						<tr>
							<th class="center hidden-320">权限中文名称</th>
							<th class="center">权限英文名称</th>
					...
					<tbody>
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								<td hidden-320><?php echo str_repeat('&ensp;', ($vo['level']-1) * 3); ?>|__ <?php echo ($vo["title"]); ?></td>
								...
								<td class="center">
									<div class="action-buttons">
										<?php if(in_array(($vo["level"]), explode(',',"1,2"))): ?><a class="blue add" title="新增下级权限" href="<?php echo U('add',array('pid'=>$vo['id'],'level'=>$vo['level']+1));?>">
												<i class="ace-icon fa fa-plus bigger-110"></i>
											</a>
										<?php else: ?>
											&emsp;<?php endif; ?>
										<a class="blue edit" title="修改" href="<?php echo U('edit',array('id'=>$vo['id'],'level'=>$vo['level']));?>">
