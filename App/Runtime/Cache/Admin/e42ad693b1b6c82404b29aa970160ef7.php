	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="field-MAIL_ADDRESS"> 发件人Email </label>
				<div class="col-sm-9">
					<input type="text" id="field-MAIL_ADDRESS" name="MAIL_ADDRESS" value="<?php echo ($data["MAIL_ADDRESS"]); ?>" placeholder="发件人Email" class="col-xs-10 col-sm-10" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="field-MAIL_FROM"> 发件人姓名 </label>
				<div class="col-sm-9">
					<input type="text" id="field-MAIL_FROM" name="MAIL_FROM" value="<?php echo ($data["MAIL_FROM"]); ?>" placeholder="发件人姓名" class="col-xs-10 col-sm-10" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="field-MAIL_SMTP"> SMTP地址 </label>
				<div class="col-sm-9">
					<input type="text" id="field-MAIL_SMTP" name="MAIL_SMTP" value="<?php echo ($data["MAIL_SMTP"]); ?>" placeholder="SMTP地址" class="col-xs-10 col-sm-10" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="field-MAIL_LOGINNAME"> SMTP用户名 </label>
				<div class="col-sm-9">
					<input type="text" id="field-MAIL_LOGINNAME" name="MAIL_LOGINNAME" value="<?php echo ($data["MAIL_LOGINNAME"]); ?>" placeholder="SMTP用户名" class="col-xs-10 col-sm-10" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="field-MAIL_PASSWORD"> SMTP密码 </label>
				<div class="col-sm-9">
					<input type="text" id="field-MAIL_PASSWORD" name="MAIL_PASSWORD" value="<?php echo ($data["MAIL_PASSWORD"]); ?>" placeholder="SMTP密码" class="col-xs-10 col-sm-10" />
				</div>
			</div>
