...
<link rel="stylesheet" href="/public/static/components/bootstrap-table/dist/bootstrap-table.min.css">
<link rel="stylesheet" href="/public/static/components/bootstrap-table/dist/extensions/tree-column/bootstrap-table-tree-column.css">
<style type="text/css">
	...
	<div class="widget-box widget-color-blue2" id="widget-box-11">
		<div class="widget-header">
			...
			<div class="widget-toolbar">
				<a href="javascript:void(0);" class="href-url" title="新增<?php echo ($nodes[$onType]); ?>" onclick='location.href="<?php echo U('add');?>"' data-action="settings">
		...
		<div class="widget-body">
			...
			<div class="widget-main no-padding scrollable" data-size="125">
				...
				<table id="data-table" class="table table-bordered table-hover">
					<thead>
						<tr>
							<th class="center hidden-320">编号</th>
							<th class="center hidden-320">部门名称</th>
					...
					<tbody>
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								<td class="center"><?php echo ($vo["groupno"]); ?></td>
								<td><?php echo str_repeat('&ensp;', ($vo['level']-1) * 3); ?>|__ <?php echo ($vo["groupname"]); ?></td>
								<td class="center"><?php echo ($vo["remark"]); ?></td>
...
<script src="/public/static/components/bootstrap-table/dist/bootstrap-table.min.js"></script>
<script src="/public/static/components/bootstrap-table/dist/extensions/tree-column/bootstrap-table-tree-column.js"></script>
<!-- Latest compiled and minified Locales -->
<script src="/public/static/components/bootstrap-table/dist/locale/bootstrap-table-zh-CN.min.js"></script>
