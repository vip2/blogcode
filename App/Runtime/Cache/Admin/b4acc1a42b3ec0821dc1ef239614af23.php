		...
		<div class="widget-body">
			...
			<div class="widget-main no-padding scrollable" data-size="125">
				...
				<table id="data-table" class="table table-bordered table-hover">
					<thead>
						<tr>
							<th class="center hidden-320">分类名称</th>
							<th class="center">分类关键词</th>
					...
					<tbody>
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								<td><?php echo str_repeat('&ensp;', ($vo['level']-1) * 3); ?>|__ <?php echo ($vo["catename"]); ?></td>
								<td class="center"><?php echo (cutStr($vo["keywords"],15)); ?></td>
