		...
		<div class="widget-body">
			...
			<div class="widget-main no-padding scrollable" data-size="125">
				...
				<table id="data-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr <?php if(($vo["level"]) == "1"): ?>class="menu-title"<?php endif; ?>>
								<td class="center">
									<div class="action-buttons">
										<a title="<?php echo ($vo["title"]); ?>"><i class="ace-icon <?php echo ($vo["icon"]); ?> bigger-110"></i></a>
									</div>
								</td>
								<td><?php echo str_repeat('&emsp;', ($vo['level']-1) * 3); ?>&emsp;<i class="ace-icon <?php echo ($vo["icon"]); ?> bigger-110"></i> <?php echo ($vo["title"]); ?></td>
								<td class="center"><?php echo ($vo["icon"]); ?></td>
								...
								<td class="center">
									<div class="action-buttons">
										<?php if(($vo["level"]) == "1"): ?><a class="blue add" title="新增下级权限" href="<?php echo U('add',array('pid'=>$vo['id'],'level'=>$vo['level']+1));?>">
