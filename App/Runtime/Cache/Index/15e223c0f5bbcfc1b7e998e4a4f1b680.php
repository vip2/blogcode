			...
			<div class="collapse navbar-collapse" id="navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
                    <?php if(is_array($navData)): foreach($navData as $key=>$vo): if(($vo["pid"]) == "0"): ?><li>
                                <a href="index.html"><!-- <span class="glyphicon glyphicon-home"></span> --> <?php echo ($vo["title"]); ?></a>
    		...
    		<div class="row">
    			...
    			<div class="col-md-4 info-right hidden-xs hidden-sm">
    				...
    				<div class="container-fluid links-a">
    					<div class="row">
    						<a class="col-md-4 col-sm-6 col-xs-12" href="#">叶子微博</a>
    						<a class="col-md-4 col-sm-6 col-xs-12" href="#">王志军博客</a>
    						<a class="col-md-4 col-sm-6 col-xs-12" href="#">张伟森博客</a>
    						<a class="col-md-4 col-sm-6 col-xs-12" href="#">封尘博客</a>
    						<a class="col-md-4 col-sm-6 col-xs-12" href="#">Leftso(左搜)</a>
    						<a class="col-md-4 col-sm-6 col-xs-12" href="#">80乐</a>
    					</div>
    				</div>
    			</div>
    		</div>
